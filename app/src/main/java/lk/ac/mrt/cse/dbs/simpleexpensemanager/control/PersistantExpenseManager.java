...
public class PersistantExpenseManager extends ExpenseManager {
    ...
    public PersistantExpenseManager(DBHandler dbHandler) {
    ...
    public void setup() {
        ...
        TransactionDAO persistantTransactionDAO = null;
        try {
            persistantTransactionDAO = new PersistantTransactionDAO(dbHandler);
